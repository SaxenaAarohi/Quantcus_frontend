...
export function IconCloudUpload(p) {
  return (
    <svg {...base} {...p}>
...
export function IconQuestion(p) {
  return (
    <svg {...base} {...p}>
      <circle cx="12" cy="12" r="9" />
